 ...
 --}}
                        ...
                        <li>
                            <a href="../admin/order"
                                ...
                                <div class="flex gap-3">
                                    ...
                                    <h2 class="poppins font text-md ">Order</h2>
                                </div>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="../admin/category"
                                ...
                                <div class="flex gap-3">
                                    ...
                                    <h2 class="poppins font text-md ">Categories</h2>
                                </div>
                            </a>
                        </li>
        ...
        <div class="bg-white lg:rounded-l-3xl w-[100%] overflow-y-auto content pb-5">
            <div class="header flex justify-between h-[4rem] items-end">
                ...
                <div class="flex  gap-1 mx-4 mb-2 ">


                    <div class="mb-2 text-end poppins">
                        <h3 class="text-sm">Tipu Pizza</h3>
                        <p class="text-xs">Admin</p>
                    </div>

                        <div class="relative inline-flex items-center justify-center w-10 h-10 bg-primary rounded-full">
                            <span class="font-medium text-white">Tp</span>
                        </div>
