...
@section('content')
    <div class="w-full pt-10 min-h-[88vh] border-2 shadow-2xl rounded-xl">
        <div class="flex justify-between w-full px-5">
            <div>
                <h1 class="text-3xl font-bold">Addons List</h1>
            </div>
            <div>
                <button id="addModalBtn" data-modal-target="addon-modal" data-modal-toggle="addon-modal"
        ...
        <x-modal id="addon-modal">
            <x-slot name="title">Add Addon </x-slot>
            <x-slot name="modal_width">max-w-2xl</x-slot>
            <x-slot name="body">
                <form id="postDataForm" method="POST" url="../addAddon" enctype="multipart/form-data">
                    @csrf
                    <div class="grid grid-cols-2 gap-4 ">
                        <div class="mt-4">
                            <x-input class="" id="AddonName" label="Name" placeholder="Enter Addon Name"
                                name="addon_name" type="text"></x-input>
                        </div>
                        <div class="mt-4">
    ...
    <script>
        function updateDatafun() {
            ...
            $('.updateDataBtn').click(function() {
                ...
                $('#addon-modal #btnText').text("Update");
