<div class="relative flex items-center justify-center w-full h-full">
    <label
        class="flex flex-col items-center justify-center w-full h-full border-2 border-gray-300 border-dashed rounded-lg cursor-pointer file-upload-label bg-gray-50">
        <div class="flex flex-col items-center justify-center pt-5 pb-6 file-upload-content">
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400">SVG, PNG, JPG or GIF (MAX. 600x600px)</p>
        </div>
